...
static void main_refModel2(void);
...
static void main_refModel2(void)
{
  ...
  /* Initialize function 'refModel2' input arguments. */
  /* Initialize function input argument 'inputMatrix'. */
  /* Initialize function input argument 'inputCent'. */
  /* Call the entry-point 'refModel2'. */
  argInit_512x7_sfix13_En10(iv);
  argInit_8x7_sfix13_En10(iv1);
  refModel2(iv, iv1, finalCent);
}
